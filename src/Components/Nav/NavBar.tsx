  ...
  return (
    <div className="container left-1/2 -translate-x-1/2 fixed top-[1rem] bg-white rounded-full z-40 shadow-xl">
      <div className="flex justify-between w-full py-4 px-8 items-center">
        ...
        <a href='http://www.supreme.com.tw/' target="blanked"><Logo className='w-[200px] h-[40px]' /></a><Link to='/'><span className="ml-3 font-light tracking-widest text-[16px] cursor-pointer"> | 企業永續</span></Link>
        </div>
