...
import ExpandingFooter from "./Footer";
export default function LandingPage() {
  ...
  const radius = useTransform(scrollYProgress, [0, 0.2], ['50px', '200px']);
  ...
  return (
    <div>
      ...
      <div className="h-[100svh]" style={heroStyle}>
        ...
        <AnimateComponent animationType="zoomIn" duration={1.5} delay={0.1} transformOrigin="100% 0%">
      ...
      <motion.div className="bg-white -mt-[10rem]" style={{borderRadius: radius}}>
        ...
        <motion.div className="bg-[#ED6B2C]" style={{borderRadius: radius}}>
